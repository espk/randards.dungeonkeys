...
export default new Vuex.Store({
  state: {
    ...
    keySchedule: [
      ...
      { rotationWeek: 5, affixes: "Tyrannical, Volcanic, Sanguine" },
      { rotationWeek: 6, affixes: "Fortified, Storming, Bursting" },
      { rotationWeek: 7, affixes: "Tyrannical, Afflicted, Bolstering" },
